...
export type DiscussionSettings = {
  ...
  /** Povoliť ľuďom pridávať komentáre k novým článkom. */
  defaultCommentStatus?: Maybe<Scalars['String']>;
  /** Povoliť notifikácie odkazu z iných blogov (pingbacks a trackbacks) v nových článkoch. */
...
export type GeneralSettings = {
  ...
  /** Formát dátumu pre všetky dátumové reťazce. */
  dateFormat?: Maybe<Scalars['String']>;
  /** Slogan stránky. */
  description?: Maybe<Scalars['String']>;
  /** Táto adresa sa používa na administrátorské účely, ako napr. notifikácia nového používateľa. */
  email?: Maybe<Scalars['String']>;
  /** Kód lokalizácie WordPress (jazyk). */
  language?: Maybe<Scalars['String']>;
  /** Číslo dňa v týždni, ktorým by mal týždeň začať. */
  startOfWeek?: Maybe<Scalars['Int']>;
  /** Formát času pre všetky časové reťazce. */
  timeFormat?: Maybe<Scalars['String']>;
  /** Mesto v rovnakej časovej zóne ako sa práve nachádzate. */
...
export enum MediaItemSizeEnum {
  ...
  Thumbnail = 'THUMBNAIL',
  /** MediaItem with the thumb-featured-page size */
  ThumbFeaturedPage = 'THUMB_FEATURED_PAGE',
  /** MediaItem with the thumb-ilovewp-featured size */
  ThumbIlovewpFeatured = 'THUMB_ILOVEWP_FEATURED',
...
/** The page type */
export type Page = ContentNode & DatabaseIdentifier & HierarchicalContentNode & MenuItemLinkable & Node & NodeWithAuthor & NodeWithComments & NodeWithContentEditor & NodeWithExcerpt & NodeWithFeaturedImage & NodeWithPageAttributes & NodeWithRevisions & NodeWithTemplate & NodeWithTitle & UniformResourceIdentifiable & {
  __typename?: 'Page';
  /** Returns ancestors of the node. Default ordered as lowest (closest to the child) to highest (closest to the root). */
  ancestors?: Maybe<HierarchicalContentNodeToContentNodeAncestorsConnection>;
  /** Connection between the NodeWithAuthor type and the User type */
...
/** The template assigned to the node */
export type PageBuilderTemplate = ContentTemplate & {
  __typename?: 'PageBuilderTemplate';
  /** The name of the template */
  templateName?: Maybe<Scalars['String']>;
};
...
export type ReadingSettings = {
  ...
  /** Stránky blogu zobrazujú najviac. */
...
/** The template assigned to the node */
export type Template_FullWidthPage = ContentTemplate & {
  __typename?: 'Template_FullWidthPage';
  /** The name of the template */
  templateName?: Maybe<Scalars['String']>;
};
