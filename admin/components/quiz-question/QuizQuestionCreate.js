...
import {Create, SimpleForm, NumberInput, TextInput, useRedirect, SelectInput} from 'react-admin'
...
const QuizQuestionCreate = () => {
  ...
  return (
    <Create title="Create a quiz question"  mutationOptions={{onSuccess: onSuccessHandler}} >
      <SimpleForm>
