  ...
  return (
    ...
    >
      <line
        ...
        y2="16"
        stroke={
          difficultyLevel >= 1 ? 'currentColor' : greyDiffcultyBackgroundColor
        }
      />
      <line
        x1="12"
        ...
        y2="10"
        stroke={
          difficultyLevel >= 2 ? 'currentColor' : greyDiffcultyBackgroundColor
        }
      />
      <line
        x1="18"
        ...
        y2="4"
        stroke={
          difficultyLevel >= 3 ? 'currentColor' : greyDiffcultyBackgroundColor
        }
      />
    </svg>
  )
